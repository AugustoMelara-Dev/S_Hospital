...
- Next safe candidates are successful admin mobile reports evidence, MySQL/MariaDB production-like validation, and real backend/LAN/printer/restore validation.
