...
| C - Reports & Analytics Premium | `codex/v1-1-reports-analytics-premium` | `C:\Projects\S_Hospital-v1-1-reports` | `frontend/src/features/reports/**`, dashboard report cards, chart/test files, `docs/ux/REPORTS_ANALYTICS_PREMIUM_REVIEW.md` | Backend report contracts, export calculations, permissions, invented KPIs | None approved | Explorer active: `019effb2-1ccc-7923-97cf-42bce747de28` | Pending explorer report | Dense reports may hide data context; chart changes must keep accessibility and dark mode |
...
- Next safe candidates are receipt settings clarity, reports density/accessibility, and POS mobile total visibility.
