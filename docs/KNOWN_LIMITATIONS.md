...
- La prueba fisica de impresora institucional media carta/carta/A5 queda `PENDING_HARDWARE_VALIDATION` hasta tener impresora real o impresora compartida del hospital.
