...
- La prueba fisica de impresora institucional media carta/carta/A5 y termica 80mm/58mm queda `PENDING_HARDWARE_VALIDATION` hasta tener impresora real o impresora compartida del hospital.
