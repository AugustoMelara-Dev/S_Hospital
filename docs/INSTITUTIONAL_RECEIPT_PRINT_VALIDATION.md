...
Estado actual: PENDING_HARDWARE_VALIDATION hasta probar en impresora fisica media carta, carta o A5.
...
- Formatos habilitados en el driver: media carta, carta o A5 segun decision del hospital.
