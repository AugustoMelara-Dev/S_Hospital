...
Estado actual: PENDING_HARDWARE_VALIDATION hasta probar en impresora fisica A5, carta, media carta, 80mm y 58mm.
...
- Formatos habilitados en el driver: A5, carta, media carta, 80mm y 58mm segun decision del hospital.
...
- Tamano de papel del driver configurado como A5, carta, media carta, 80mm o 58mm segun la prueba.
...
4. Cobrar factura.
5. Abrir recibo institucional en A5.
6. Imprimir.
...
- PC de caja.
- Modelo de impresora.
- Formato probado: A5, carta, media carta, 80mm, 58mm o combinacion aprobada.
