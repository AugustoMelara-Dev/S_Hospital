...
iniciar la automatizacion de respaldos. Este fallback usa Startup/HKCU Run del
usuario actual y solo se debe usar si las tareas Windows no pueden instalarse
con administrador. Para revisar estado sin exponer rutas locales:
