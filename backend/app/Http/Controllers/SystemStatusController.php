...
class SystemStatusController extends Controller
{
    ...
    private const PHYSICAL_PROOFS = [
        ...
        'FINAL_STARTUP_TASK_PROOF' => [
            'label' => 'Autoarranque final del servidor',
            'required_file' => 'qa/FINAL_STARTUP_TASK_PROOF.md',
            'fields' => [
                'Date/time',
                'Responsible person',
        ...
        'FINAL_BACKUP_TASK_PROOF' => [
            'label' => 'Tareas y respaldo manual final',
            'required_file' => 'qa/FINAL_BACKUP_TASK_PROOF.md',
            'fields' => [
                'Date/time',
                'Responsible person',
                'Server computer name',
