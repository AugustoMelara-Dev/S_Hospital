...
class FiscalSettingsTest extends TestCase
{
    ...
    public function test_admin_can_upload_logo_and_public_endpoint_returns_cache_busted_url(): void
    {
        ...
        $this->assertSame(FiscalSetting::class, $audit->entity_type);
        $this->assertSame(['logo_present' => false], $audit->old_values);
        $this->assertSame(true, $audit->new_values['logo_present']);
        $this->assertSame('hospital.png', $audit->new_values['original_name']);
