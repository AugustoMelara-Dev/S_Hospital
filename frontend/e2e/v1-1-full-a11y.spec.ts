...
const reportPath = resolve(process.env.E2E_V1_1_FULL_A11Y_REPORT_PATH ?? '../qa/production-audit/v1-1-full-a11y-report.json');
...
for (const viewport of smokeViewports) {
  test(`v1.1 full a11y matrix passes at ${viewport.name}`, async ({ page }) => {
