...
describe('App', () => {
        ...
        readiness: {
          ...
          blockers: [
            ...
            },
            {
              ...
              label: 'Validacion fisica A5/carta/media carta/80mm/58mm',
              status: 'pending',
            },
          ],
        },
        preflight: {
          ...
          physical_proofs: [
            ...
            },
            {
              ...
              label: 'Impresora institucional A5/carta/media carta/80mm/58mm',
  ...
  it('renders backups view actions for an admin', async () => {
    ...
    expect(await screen.findByText(/validar recibo fisico A5\/carta\/media carta\/80mm\/58mm/i)).toBeInTheDocument();
