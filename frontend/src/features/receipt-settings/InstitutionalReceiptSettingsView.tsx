...
export function InstitutionalReceiptSettingsView({ canEdit, onStatus }: InstitutionalReceiptSettingsViewProps) {
  ...
  useEffect(() => {
    ...
    institutionForm.reset({
      ...
      government_line: institution?.government_line ?? 'Gobierno de Honduras',
      secretariat_line: institution?.secretariat_line ?? 'Secretaria de Salud',
      receipt_location: institution?.receipt_location ?? 'Tocoa, Colon',
      receipt_footer_text: institution?.receipt_footer_text ?? 'Original: Oficina Recaudadora',
      receipt_template_mode: 'institutional',
    });
