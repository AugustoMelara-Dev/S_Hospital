...
const renderSheet = (props: Partial<React.ComponentProps<typeof CategorySheet>> = {}) => render(<CategorySheet open onOpenChange={noop} category={null} onSuccess={noop} {...props} />);
...
describe('CategorySheet', () => {
  ...
  it('exposes an accessible Ant drawer for create and edit', () => {
    ...
    rerender(<CategorySheet open onOpenChange={noop} category={{ id: 4, name: 'Laboratorio', sort_order: 2, active: true }} onSuccess={noop} />);
