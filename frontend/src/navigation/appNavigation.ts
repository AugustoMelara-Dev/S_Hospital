...
export const appRoutes = {
  ...
  reports: {
    ...
    navigationGroup: 'operations',
    navigation: true,
    navigationPermissions: ['reports.view', 'reports.managerial.view', 'reports.cash_session.view', 'audit.view'],
    requiredPermissions: ['reports.view', 'reports.managerial.view', 'reports.cash_session.view', 'audit.view'],
    permissionMode: 'any',
