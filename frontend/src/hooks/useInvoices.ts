...
function normalizeInvoiceFilters(filters: InvoiceFilters): InvoiceFilters {
  const normalized: InvoiceFilters = {
    ...
    balance_state: normalizeTextFilter(filters.balance_state) as InvoiceFilters['balance_state'],
    receipt_state: normalizeTextFilter(filters.receipt_state) as InvoiceFilters['receipt_state'],
    reconciliation_cash_session_id: normalizeTextFilter(filters.reconciliation_cash_session_id),
