...
if ($failures.Count -eq 0) {
    ...
    $requiredRequirements = @(
        ...
        'Realtime own-event notifications do not distract the acting cashier',
    ...
    $requiredEvidence = @(
        ...
        'qa/MARIADB_MIGRATION_VALIDATION_2026_06_07.md',
        ...
        'qa/REALTIME_OWN_EVENT_SAFETY_2026_06_04.md',
