...
Assert-Contains 'qa/lan-emulation/cashier.js' '/up failed with status' 'hard failure when health check is not OK'
Assert-Contains 'qa/lan-emulation/cashier.js' 'login did not reach dashboard' 'hard failure when login does not reach dashboard'
Assert-Contains 'qa/lan-emulation/cashier.js' 'invoice scenario did not reach the new-invoice form' 'hard failure when invoice form is unavailable'
...
Assert-Contains 'qa/lan-emulation/orchestrator.js' 'exceeded \$\{SLA_TOTAL_MS\}ms' 'hard failure when LAN emulation exceeds SLA'
...
Assert-Contains 'qa/loadtest/fiscal-race.js' 'could not open or reuse a cash session' 'hard failure when validation cash session is unavailable'
