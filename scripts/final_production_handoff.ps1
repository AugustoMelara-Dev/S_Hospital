...
function Write-HandoffReport(
    ...
    Add-ReportLine $lines '- Material y evidencia de operacion: `docs/manuales`, `docs/RELEASE_CHECKLIST.md`, `docs/FINAL_FIELD_BLOCKERS.md`, `qa/TRAINING_ACCEPTANCE_PROOF.example.md`, evidencias QA de seguridad historicas y capturas RC vigentes en `qa/browser-smoke-2026-06-08`.'
    Add-ReportLine $lines ""
