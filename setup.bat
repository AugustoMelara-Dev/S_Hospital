@echo off
REM ======================================================================
REM      [HOSPITAL BILLING OS - LAN DEPLOYMENT MASTER LAUNCHER]
REM ======================================================================
...
cd /d "%~dp0"
title "Hospital Billing OS - Lanzador de Despliegue LAN"
cls

echo ======================================================================
echo          [HOSPITAL BILLING OS - INICIALIZADOR DE PRODUCCION]
echo ======================================================================
echo.
