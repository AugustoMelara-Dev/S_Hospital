...
- `NewInvoiceView` todavia muestra servicios como lista filtrable y no como POS por categorias e identificador.
- La busqueda solo cruza nombre y categoria; no hay campo dedicado de identificador ni soporte visible de escaneo de servicios.
- `CatalogView` tiene categorias, busqueda y tabla, pero aun no expone identificadores de escaneo.
