...
Do not declare `PRODUCTION_READY` yet. The server-side production checks passed, but real second-client LAN proof and physical institutional receipt proof for media carta/carta/A5 are still missing.
