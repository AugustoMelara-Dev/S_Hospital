...
## Local disposable backup/restore

Status: PASS locally, still pending final hospital-site operator execution.

- Evidence: `qa/field-acceptance/restore-validation-local-20260625213129.md`.
...
- Result: backup generated by Laravel, decrypted, imported into separate disposable DB, and core source/restore counts matched.
- Limit: this was local Docker/MariaDB evidence, not the final hospital-site restore acceptance.
