...
- Generated at: 2026-06-04 19:39:43
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File scripts\validate_final_handoff_completeness.ps1 -HandoffPath %PROJECT_ROOT%\qa\FIRST_LEVEL_SUPPORT_HANDOFF_RESULT_2026_06_04.md
powershell.exe -NoProfile -ExecutionPolicy Bypass -File scripts\validate_ops_evidence_index.ps1 -HandoffPath %PROJECT_ROOT%\qa\FIRST_LEVEL_SUPPORT_HANDOFF_RESULT_2026_06_04.md
...
[FAIL] MANIFEST.txt must reference current commit e85d07c5 before release handoff.
...
[ OK ] Found scripts\assert_offline_release_clean.ps1
[ OK ] Found docs\RELEASE_CHECKLIST.md
[ OK ] Final handoff declares 33 script dependency/dependencies
...
```text
[OK] SelfTest passed. default.conf=75 lines, crontab=10 lines, scripts=49, docs=7, proofTemplates=5, hash=FA6766529DE302FE3B24866543E4F44EEFEA35681DE1C527C31D13E4CDA84444
```
...
[OK] Referencias qa/ verificadas: 36
