...
`PRODUCTION_READY` until A5, carta, media carta, 80mm and 58mm output are validated on the
...
## A5 physical print result

- A5 result:
- A5 evidence/reference:
- A5 observations:

## Carta, media carta and thermal physical print result
