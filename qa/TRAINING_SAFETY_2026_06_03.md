...
- Validate that cashier, supervisor and administrator exercises remain documented.
...
- Help screen still exposes `Capacitación segura`, `Modo práctica`, isolated practice guidance and the warning not to use the production database.

Safety notes:

- This check reads only versioned docs and frontend source/test files.
