...
1. Bloqueantes de produccion real: segunda PC en LAN, impresora institucional fisica media carta/carta/A5, entorno production final y worker continuo de backups.
...
| Produccion real | `NO PRODUCTION_READY` | Falta evidencia de segunda PC LAN, impresora fisica media carta/carta/A5 y cierre completo del entorno production final. |
...
- La UI y los tests cubren recibo media carta/carta/A5.
...
- Probar recibo media carta, carta o A5 con la impresora final o la configuracion exacta de caja.
...
| PDF avanzado | No incluir como bloqueante | Recibo institucional media carta/carta/A5 es el flujo critico de caja. |
...
- `qa/INSTITUTIONAL_RECEIPT_PRINT_PROOF.md` completo, sin placeholders, con impresora fisica media carta/carta/A5.
