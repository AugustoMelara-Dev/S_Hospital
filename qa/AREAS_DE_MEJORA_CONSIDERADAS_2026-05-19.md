...
1. Bloqueantes de produccion real: segunda PC en LAN, impresora institucional fisica A5/carta/media carta/80mm/58mm, entorno production final y worker continuo de backups.
...
| Produccion real | `NO PRODUCTION_READY` | Falta evidencia de segunda PC LAN, impresora fisica A5/carta/media carta/80mm/58mm y cierre completo del entorno production final. |
...
- La UI y los tests cubren recibo A5/carta/media carta/80mm/58mm.
...
| PDF avanzado | No incluir como bloqueante | Recibo institucional A5/carta/media carta/80mm/58mm es el flujo critico de caja. |
...
- `qa/INSTITUTIONAL_RECEIPT_PRINT_PROOF.md` completo, sin placeholders, con impresora fisica A5/carta/media carta/80mm/58mm.
