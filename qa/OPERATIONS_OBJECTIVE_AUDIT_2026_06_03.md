...
| Browser evidence for critical flows with console issues captured | `qa/browser-smoke-2026-06-08/controlled-e2e-report.json`, `qa/BROWSER_SMOKE_EVIDENCE_2026_06_08.md` | `VALIDATED_LOCAL` | Repeat smoke on final server/LAN after production install |
...
| Automatic and manual backup plus safe restore validation | `qa/BACKUP_WORKER_SMOKE_2026_06_03.md`, `qa/BACKUP_RESTORE_DOCS_SAFETY_2026_06_03.md`, `qa/FINAL_BACKUP_TASK_PROOF.example.md`, `qa/FINAL_BACKUP_TASK_PROOF.md`, `scripts/validate_final_backup_task_proof.ps1`, `qa/FINAL_RESTORE_PROOF.md`, `qa/FINAL_RESTORE_PROOF_2026_06_03.md`, `scripts/validate_final_handoff_completeness.ps1` | `PARTIAL_FIELD_BLOCKED` | Install final backup tasks, run final backup automation smoke, complete `qa/FINAL_BACKUP_TASK_PROOF.md` after a manual UI backup moves from Pendiente to Protegido, restore only into disposable final-server database |
...
| Non-technical manuals and role checklists for cashier, supervisor, administrator and area users | `qa/OPERATOR_MANUALS_SAFETY_2026_06_03.md`, `docs/manuales/INDICE_OPERADOR.md`, `docs/manuales/MANUAL_USUARIO_AREA.md` | `VALIDATED_LOCAL` | Train real staff and record any acceptance with anonymized evidence only |
...
| Final LAN client validation from a second computer by IP | `qa/LAN_CLIENT_VALIDATION_PROOF.example.md`, `scripts/validate_lan_client.ps1`, `scripts/validate_lan_client_proof.ps1`, `qa/LAN_CLIENT_PROOF_GUARD_2026_06_05.md`, `scripts/init_production_proofs.ps1`, `qa/FIELD_PROOF_TEMPLATES_SAFETY_2026_06_03.md`, `qa/PROOF_INITIALIZATION_SAFETY_2026_06_03.md` | `PENDING_FINAL_FIELD` | Run `scripts\final_production_handoff.ps1 -InitializeProofFiles`, then complete `qa/LAN_CLIENT_VALIDATION_PROOF.md` from a real second PC on the hospital LAN; pending guard mode must pass and final guard mode must fail until real evidence exists |
| Physical institutional receipt proof for media carta, carta and A5 | `qa/INSTITUTIONAL_RECEIPT_PRINT_PROOF.example.md`, `docs/INSTITUTIONAL_RECEIPT_PRINT_VALIDATION.md`, `scripts/validate_institutional_receipt_print_proof.ps1`, `scripts/init_production_proofs.ps1`, `qa/FIELD_PROOF_TEMPLATES_SAFETY_2026_06_03.md`, `qa/PROOF_INITIALIZATION_SAFETY_2026_06_03.md` | `PENDING_FINAL_FIELD` | Run `scripts\final_production_handoff.ps1 -InitializeProofFiles`, then complete `qa/INSTITUTIONAL_RECEIPT_PRINT_PROOF.md` with real cashier printer evidence |
...
| `PRODUCTION_READY` gate and final-field blockers cannot be bypassed silently | `docs/FINAL_FIELD_BLOCKERS.md`, `qa/PRODUCTION_READY_GATE_VALIDATOR_2026_06_04.md`, `qa/PRODUCTION_READY_GATE_HANDOFF_2026_06_04.md`, `qa/PRODUCTION_READY_GATE_HANDOFF_RESULT_2026_06_04.md`, `qa/FINAL_FIELD_BLOCKERS_SAFETY_2026_06_04.md`, `scripts/validate_production_ready_gate_safety.ps1`, `scripts/validate_final_field_blockers_safety.ps1` | `VALIDATED_LOCAL` | Keep final LAN, printer, startup, backup, restore, concurrency and training proof incomplete until real field evidence exists; use `docs/FINAL_FIELD_BLOCKERS.md` as the operator-facing index and do not use bypass flags for final approval |
...
- Final production environment values, final startup task proof, final backup automation smoke, final backup task proof, final restore proof, final concurrency proof, final training proof and final preflight are still missing.
...
- `docs\FINAL_FIELD_BLOCKERS.md` is the operator-facing index for the seven final proofs and must stay aligned with the handoff and proof validators.
- The 2026-06-04 handoff guard evidence proves the local gate wiring, not the final hospital LAN, printer, startup, backup, restore, concurrency or training proof.
