...
| Automatic and manual backup plus safe restore validation | `qa/BACKUP_WORKER_SMOKE_2026_06_03.md`, `qa/BACKUP_RESTORE_DOCS_SAFETY_2026_06_03.md`, `qa/FINAL_RESTORE_PROOF.md`, `qa/FINAL_RESTORE_PROOF_2026_06_03.md`, `scripts/validate_final_handoff_completeness.ps1` | `PARTIAL_FIELD_BLOCKED` | Install final backup worker, run final backup worker smoke, confirm the handoff lists missing backup tasks as blocking, restore only into disposable final-server database |
