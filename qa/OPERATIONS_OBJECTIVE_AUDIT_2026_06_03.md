...
| Offline release package can be installed without internet and matches final commit | `qa/OFFLINE_RELEASE_BUILDER_SELFTEST_2026_06_03.md`, `qa/OFFLINE_RELEASE_GUARD_2026_06_03.md`, `scripts/make_offline_release.ps1`, `scripts/assert_offline_release_clean.ps1`, `scripts/validate_dependency_manifest.ps1` | `PENDING_FINAL_FIELD` | Regenerate `offline-release` from final commit with Docker image tar files, matching checksums and current dependency manifest guard |
