...
| Browser evidence for critical flows with console issues captured | `qa/browser-smoke-2026-06-08/rc-e2e-mocked-report.json`, `qa/BROWSER_SMOKE_EVIDENCE_2026_06_08.md` | `VALIDATED_LOCAL` | Repeat smoke on final server/LAN after production install |
