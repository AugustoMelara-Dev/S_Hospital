...
- Generated at: 2026-06-03 23:47:31
...
[FAIL] MANIFEST.txt must reference current commit a35a7cdc before release handoff.
[FAIL] offline-images contains no Docker image tar files.

OFFLINE_RELEASE_CLEAN: NO (47 blocking issue(s))
```
...
```text
[OK] SelfTest passed. default.conf=108 lines, crontab=10 lines, scripts=39, docs=7, proofTemplates=5, hash=9A27BC9EC6BD8C54C693CAF302557C1B93F7EB37EEFA3D38D8F052CECD34EA60
```
...
[OK] Referencias qa/ verificadas: 29
